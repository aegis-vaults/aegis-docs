...
```json
{
  ...
  "lastReset": "2024-12-03T00:00:00.000Z",
  "name": "My Vault",
  "paused": false,
  "whitelistCount": 5,
  "createdAt": "2024-01-01T00:00:00.000Z",
...
```bash
curl "https://aegis-guardian-production.up.railway.app/api/analytics?vault=7xKX...&startDate=2024-01-01&endDate=2024-12-31&groupBy=month"
```
...
```json
{
  ...
  "utilizationPct": 25.0,
  "transactionsToday": 3,
  "lastTransaction": "2024-12-03T00:00:00.000Z"
}
```
