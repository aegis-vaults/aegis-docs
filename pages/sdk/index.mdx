...
|---------|-----|----------------|
| Type Safety | ✅ Full TypeScript | ❌ Manual types |
| Error Handling | ✅ Custom errors | ❌ Raw Anchor errors |
| Guardian Integration | ✅ Built-in | ❌ Manual API calls |
| Retry Logic | ✅ Automatic | ❌ Manual retry |
| PDA Derivation | ✅ Automatic | ❌ Manual seeds |
| Amount Conversion | ✅ Helper utils | ❌ Manual calculation |
| AI Integrations | ✅ Pre-built tools | ❌ Build from scratch |

## Network Support

| Network | Status | Configuration |
|---------|--------|---------------|
| **Devnet** | ✅ Live | `cluster: 'devnet'` |
| **Mainnet** | 🚧 Coming Soon | `cluster: 'mainnet-beta'` |
| **Custom RPC** | ✅ Supported | Provide `Connection` instance |
